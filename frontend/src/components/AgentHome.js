...
function AgentHome() {
  ...
  const columns=[
    ...
    onClick={ () => {handleForm(row)} }>Collect
    </button>):<span>Collected</span>}
  ]
...
<BootstrapTable bootstrap4 keyField="id" columns={columns} data={requests}
