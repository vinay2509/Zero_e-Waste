...
const Viewcard = ({ request }) => {
  ...
  return (
      ...
      <div class="col-xs-12 col-sm-6 col-md-3">
        ...
        <div class="card mb-4  viewcard_bg" style={{width:"20rem",height:"25rem"}}>
        ...
        <table>
        <tr>
          <td><h5><u>Name</u></h5></td>
          <td><h5>: {request.name}</h5></td>
        </tr>
        <tr>
          <td><h5><u>Email</u></h5></td>
          <td><h5>: {request.email} </h5></td>
        </tr>
        <tr>
          <td><h5><u>Address</u></h5></td>
          <td><h5>: {request.address} </h5></td>
        </tr>
        <tr>
        <td><h5><u>Qty</u></h5></td>
        <td><h5>: {request.quantity} </h5></td>
        </tr>
        <tr>
        <td><h5><u>Item</u></h5></td>
        <td><h5>: {request.ewasteQty} </h5></td>
        </tr>
        </table>
        <div class="row">
        <div class="col-lg-6 text-right">
        <Link class="btn btn-lg btn-primary" to="/update" onClick={setID}>  Update  </Link> 
        </div>
        ...
        {checkimageuploadstatus()}
          { 
            load?"Image already uploaded":(<ImageUploader reqdetails={request} />)
          }
        </div>
