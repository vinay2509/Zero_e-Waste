...
function Adminusers() {
  ...
  const columns=[
    ...
    {text:'Action',formatter:(cell, row) => (<button type="button" class="btn btn-outline-danger btn-sm badge-pill" onClick={ () => handleDelete(row)  }>Delete</button>)}
      ...
      <div class="container mt-5 pt-3 ">
        ...
        <div class="card card-bg">
          ...
          <div class="card-body bt">
            ...
            <BootstrapTable bootstrap4 keyField="email" columns={columns} data={users}
